...
<body background="<%=request.getContextPath()%>/images/background.jpg">
	...
	<form action="<%=request.getContextPath()%>/review/removeStopword.do"
		method="post">
		...
		<table>
			<tr>
				...
				<td><input name="stopWord" id="stopWord" type="text" size="50"
					maxlength="50" /></td>
			</tr>
			<tr>
				<td><input type="submit" value="Remove StopWord"
					onclick="validatestopword()" /></td>
			</tr>
